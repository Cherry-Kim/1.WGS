...
cohort='YUHL_WGS'
file_list=os.listdir('/home/DATA/YUHL/WGS/')
...
CHR.append('M')
#for i in CHR:
#	os.system('java -Xmx64g -jar /home/program/gatk-4.0.11.0/gatk-package-4.0.11.0-local.jar GenomicsDBImport '+" ".join(map(lambda z:"-V "+z, vcf_list))+' --genomicsdb-workspace-path YUHL_DB'+i+' --intervals chr'+i)

	### STEP2. Joint-call samples in a GenomicDB datastore
#	os.system('java -Xmx4g -jar /home/program/gatk-4.0.11.0/gatk-package-4.0.11.0-local.jar GenotypeGVCFs -R /home/hykim/REF/Human/hg19/hg19.fa -V gendb://YUHL_DB'+i+' -O chr'+i+'.Genotype.vcf')
